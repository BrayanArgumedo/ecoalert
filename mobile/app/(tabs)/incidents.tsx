  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#030d06' }}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 }}>
        <View style={{ width: 72, height: 72, borderRadius: 22, backgroundColor: 'rgba(245,158,11,0.15)', borderWidth: 1, borderColor: 'rgba(245,158,11,0.3)', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
          <Ionicons name="warning-outline" size={34} color="#f59e0b" />
        </View>
        <Text style={{ color: 'white', fontSize: 20, fontWeight: '800', textAlign: 'center' }}>Incidentes</Text>
